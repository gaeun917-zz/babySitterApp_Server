		...
		<div style="padding-top: 30px;">
			<div id="inputcontent">
					...
					<form action="write.action" method="post"
						...
						<input type="hidden" name="motherNo"
									value='${ sessionScope.loginuser.motherNo }' />
						<table class="table table-striped">

							<tr>
								<th style="height: 30px">등록인</th>
								<td><input type="hidden" name="uploader"
									value='${ sessionScope.loginuser.motherId }' /> ${ sessionScope.loginuser.motherId }
								</td>
							</tr>
							<tr>
								<th>제목</th>
						...
						<div class="buttons" style="text-align: center">
							<input class="btn btn-default" type="submit" value="자료등록" 
								...
								value="취소" 
								onclick="location.href='/babySitter/home.action';" />
						</div>
					</form>
			</div>
		</div>
	...
	$(function() {
		...
		function submitContents(elClickedObj) {
			...
			try {
				...
				/* var url = '/babySitter/page/board/list.action?menuno=' + ${menu.menuNo} + '&Motherpageno=' + ${memberpageno}; 
