<%-- <%@page import="com.babySitter.model.dto.SmallCategory"%>
<%@page import="com.babySitter.model.dto.BoardComment"%> --%>
...
<!-- Bootstrap Core CSS -->
<link href="/babySitter/resources/bootstrap/css/bootstrap.min.css"
	rel="stylesheet">
<!-- Custom CSS -->
<link href="/babySitter/resources/bootstrap/css/small-business.css"
	rel="stylesheet">
<link rel="Stylesheet" href="/babySitter/resources/styles/list.css" />
...
<script src="/babySitter/resources/bootstrap/js/bootstrap-select.min.js"></script>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-8">
				<img class="img-responsive img-rounded"
					src="/babySitter/resources/boardimage/${board.boardNo}.jpg"
										alt="" />
			</div>
			<!-- /.col-md-8 -->
			<div class="col-md-4" style="text-align: left; ">
				...
				<h4>모임 정보</h4>
					<ul style="list-style: none; margin: 0; padding: 0;">
						<li><strong>개설자</strong> <span style="margin-left: 130px">
						...
						<li><strong>모집 인원 수</strong> <span id="mothers" style="margin-left: 100px">${membercount} / ${board.memberCount} 명</span></li></br>
		...
		<div class="col-md-4" style="width: 950px; height: 350px;">
			...
			$('#register').on('click', function(event) {
				...
				$.ajax({
					url : '/babySitter/board/enjoy.action',
					type : 'get',
