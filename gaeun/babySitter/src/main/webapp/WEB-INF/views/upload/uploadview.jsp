<%-- <%@page import="com.babySitter.model.dto.UploadFile"%>
<%@page import="com.babySitter.model.dto.Upload"%>
<%@page import="com.babySitter.model.dao.UploadDao"%>
			...
			<div class="col-xs-12 col-sm-9" style="text-align: center">
				<div id="inputcontent">
			       <div class="panel panel-default">
				           ...
				           <table class="table">
					               ...
					               <tr>
					                   ...
					                   <td style="text-align: left;">
					                   	<c:forEach var="mother" items="${ upload.motherId }">
					                   		${ mother.motherId }	
					                   	</c:forEach>
					                   </td>
					               </tr>
			           ...
			           <div class="buttons">
			           	<c:choose>
			           		<c:when test="${ sessionScope.loginuser.motherNo eq upload.motherNo }">
