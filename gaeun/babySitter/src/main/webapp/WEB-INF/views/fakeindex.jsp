...
<link href="/babySitter/resources/css/bootstrap.min.css" rel="stylesheet"/>
<script type="text/javascript" src="http://code.jquery.com/jquery-1.12.4.js"></script>
<script src="/babySitter/resources/js/bootstrap.min.js"></script>
...
<script type="text/javascript">
	$(function() {
		...
		$('#Motherid').on('keyup', function(event) {
			var key = $(this).val();
			if (key.length == 0) {
				$('#divAutoCom').remove();
				return;
			...
			$.ajax({
				url : '/babySitter/search.action', //'/ajaxweb/getsuggestions.action&id='+id
				type : 'get',
				data : {
					id : key
		...
		$(function() {
					...
					if (response.status === 'connected') {
						...
						FB.api('/me',//현재 로그인된 사용자 정보 요청
						   function(response2) {
								...
								$.ajax({
									url : '/babySitter/account/facebookLogin.action',
									type : 'post',
			...
			$('#logout').on('click', function(event) {
				FB.logout(function(result) {
					//서버에 로그아웃 처리
					 $.ajax({
						url : '/babySitter/account/logout.action',
						type : 'get',
						success : function(data, status, xhr) {
					 		checkLoginState();
						}
...
<div id="header">
	<div class="title">
		<a href="/babySitter/home.action" >&nbsp;&nbsp;Airbnb</a>
	</div>
	<div class="links">
		

			<a href="/babySitter/rooms/list.action" style="font-weight: bold;">호스팅하기</a> 
			<a href="/babySitter/upload/uploadlist.action" style="font-weight: bold;">자료실</a> <a
			href="/babySitter/board/list.action" style="font-weight: bold;">게시판</a> <a
			href="/babySitter/info/info.action" style="font-weight: bold;">test-sw</a>
		...
		<c:choose>
			<c:when test="${ not empty sessionScope.loginuser }">
				...
				<a href="/babySitter/account/logout.action" id="logout">로그아웃</a>
			</c:when>
			...
			<c:otherwise>
				...
				<a href="/babySitter/mother/register.action" style=" font-weight: bold;">등록</a>
			</c:otherwise>
		</c:choose>
	</div>
</div>
	...
	<div class="container">
		...
		<div class="col-sm-4">
			<h2>경기도</h2>
			<img alt="myeong-dong" src="/babySitter/resources/image/gyonggi.jpg"
				class="img-rounded">
		</div>

		<div class="col-sm-4">
			<h2>충청도</h2>
			<img alt="gangnam" src="/babySitter/resources/image/choongchung.jpg"
				class="img-rounded">
		</div>

		<div class="col-sm-4">
			<h2>경상도</h2>
			<img alt="gangnam" src="/babySitter/resources/image/kyongsang.jpg"
				class="img-rounded">
		</div>

		<div class="col-sm-4">
			<h2>전라도</h2>
			<img alt="hongdae" src="/babySitter/resources/image/jeonra.jpg"
				class="img-rounded">
		</div>

		<div class="col-sm-4">
			<h2>제주도</h2>
			<img alt="hongdae" src="/babySitter/resources/image/jeju.jpg"
				class="img-rounded">
		</div>
	</div>
	<div id="footer"></div>
