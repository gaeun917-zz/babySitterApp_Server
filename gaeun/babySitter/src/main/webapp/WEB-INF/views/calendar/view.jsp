...
<%@page import="com.babySitter.model.dao.CalendarDao"%> --%>
			      ...
			      <div class="panel-heading"><h4><strong>일정 상세 정보</strong></h4></div>			
					<table class="table">
						...
						<tr>
							...
							<td style="text-align: left;"><c:forEach var="mother" items="${ calendar.motherId }">
				                   		${ mother.motherId }	
				                 </c:forEach>
				            </td>
						</tr>
					...
					<div class="buttons">
			           	<c:choose>
			           		<c:when test="${ sessionScope.loginuser.motherNo eq calendar.motherNo }">
