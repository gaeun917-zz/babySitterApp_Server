<%-- <%@page import="com.babySitter.model.dto.Calendar"%>
...
<script type="text/javascript" src="/babySitter/resources/js/HuskyEZCreator.js" charset="utf-8"></script>
<script type="text/javascript">
	$(function() {
		...
		nhn.husky.EZCreator.createInIFrame({
			oAppRef : oEditors,
			elPlaceHolder : "ir1",
			sSkinURI : "/babySitter/resources/SmartEditor2Skin.html",
			htParams : {
		...
		function submitContents(elClickedObj) {
			...
			try {
				...
				/* var url = '/babySitter/page/board/list.action?menuno=' + ${menu.menuNo} + '&memberpageno=' + ${memberpageno}; 
						...
						<form action="write.action" method="post">
							<table class="table">
								...
								<tr>
									...
									<td style="text-align: left;">
					                	<input type="hidden" name="memberNo" value='${ sessionScope.loginuser.motherNo }' />
					                	${ sessionScope.loginuser.motherId }
					                </td>
								</tr>
								<tr>
									...
									<td style="text-align: left;">
										...
										<input type="hidden" name="motherpageno" value="${motherpageno}" />
									</td>
								</tr>
								<tr>
							...
							<div class="buttons" style="text-align: center;">
								...
								&nbsp;&nbsp; <a href="/babySitter/board/list.action">목록보기</a> -->
								...
								<button type="button" value="취소" class="btn btn-primary btn-sm"
									onclick="location.href='list.action?motherpageno=${motherpageno}&noticemenu=${noticemenu.menuNo}';">취소</button>
							</div>
							<br/>
						</form>
					</div>
