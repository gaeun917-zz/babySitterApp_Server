...
<%@page import="com.babySitter.model.dto.PageMenu"%> --%>
...
<!-- <link href='/babySitter/resources/styles/fullcalendar.css'
	rel='stylesheet' />
<link href='/babySitter/resources/styles/fullcalendar.print.css'
...
<!-- <div class="jumbotron"> -->
<div class="container">
	<a href="/babySitter/page/board/list.action?menuno=${noticemenu.menuNo}
							&pageno=1&memberpageno=${memberpageno}"> <img
		src="/babySitter/resources/uploadimage/${memberpageno}.jpg"
		style="width: 100%; height: 250px;" />
	</a>
	<!-- <a href="/babySitter/page/page.action"><h1>Hello, world!</h1></a>
		...
		<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		  <div class="modal-dialog">
		    <div class="modal-content">
		      ...
		      <form action="/babySitter/page/image.action?menuno=${noticemenu.menuNo}
...
<script type="text/javascript">
	...
	$(function() {
		$('#modalBtn').on('click', function(event) {
			...
			$.ajax({
				url : '/babySitter/page/board/plus.action',
				type : 'get',
				data : {
					name : name,
	...
	<div class="row row-offcanvas row-offcanvas-right">
		...
		<div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar">
			<div class="list-group" style="text-align: center">
				<h4 class="panel-title"><a href='/babySitter/page/board/list.action?menuno=${noticemenu.menuNo}
							&pageno=1&memberpageno=${memberpageno}' class="list-group-item">
							공지 사항
					</a></h4>
				<h4 class="panel-title"><a href="/babySitter/upload/list.action?memberpageno=${memberpageno}&noticemenu=${noticemenu.menuNo}" class="list-group-item">자료실</a></h4>
				<h4 class="panel-title"><a href="/babySitter/calendar/list.action?memberpageno=${memberpageno}&noticemenu=${noticemenu.menuNo}" class="list-group-item">일정</a></h4>
			...
			<%-- 				<a	href='/babySitter/page/board/list.action?menuno=<%=m.getMenuNo()%>
							&pageno=<%=request.getAttribute("pageno")%>&motherpageno=${motherpageno}'
