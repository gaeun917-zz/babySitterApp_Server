...
<link href="/babySitter/resources/bootstrap/css/bootstrap.min.css"
	rel="stylesheet">
<link href="/babySitter/resources/bootstrap/css/kfonts2.css"
	rel="stylesheet">
...
<script type="text/javascript"
	src="/babySitter/resources/js/HuskyEZCreator.js" charset="utf-8"></script>
<script type="text/javascript">
	$(function() {
		var oEditors = [];
			...
			<form action="writeform.action" method="post">
				...
				<div class="panel panel-default">
					...
					<table class="table table-bordered">
						...
						<tr>
							...
							<td><%=((Mother) session.getAttribute("loginuser")).getFirst_name()%>
							</td>
						</tr>
				...
				<div>
					<div class="buttons">
						...
						&nbsp;&nbsp; 
						<a	href="/babySitter/page/board/list.action?menuno=${menu.menuNo}&memberpageno=${memberpageno}">목록보기</a>
					</div>
				</div>
			</form>
		</div>
