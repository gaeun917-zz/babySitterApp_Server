...
<%@page import="com.babySitter.model.dto.PageBoard"%>
	...
	<div class="">
		...
		<div id="pageContainer">
			...
			<div class="col-xs-12 col-sm-9" style="text-align: center">
					...
					<%Member member = (Mother) request.getAttribute("mother");%>
				      ...
				      <div class="panel-heading"><h4><strong>${menu.name}</strong></h4></div>
							<table class="table">
								...
								<tr>
									...
									<td style="text-align: left;"><%=mother.getmotherId()%></td>
								</tr>
								<tr>
						...
						<div class="buttons">
							<c:choose>
			           		<c:when test="${ sessionScope.loginuser.motherNo eq board.motherNo }">
			           		<div class="row">
