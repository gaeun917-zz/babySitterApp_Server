<%-- <%@page import="com.babySitter.model.dto.Page"%> --%>
...
<html>
	<head>
		...
		<script src="/babySitter/resources/js/carousel.js"></script>
	...
	<!-- image list START -->					
		<div class="carousel-inner">								
			...
			<div class="item active" >
				<img  style="height: 550px; width: 1600px" src="/babySitter/resources/image/carousel/study1.jpg" alt="first">
			...
			<div  class="item">
				<img style="height: 550px; width: 1600px" src="/babySitter/resources/image/carousel/study2.jpg" alt="second">
				<div class="carousel-caption">
			...
			<div class="item">
				<img style="height: 550px; width: 1600px" src="/babySitter/resources/image/carousel/study3.JPG" alt="third">
				<div class="carousel-caption">
			...
			<div class="item">
				<img style="height: 550px; width: 1600px" src="/babySitter/resources/image/carousel/study4.jpg" alt="fourth">
				<div class="carousel-caption">
			...
			<div class="item">
				<img style="height: 550px; width: 1600px" src="/babySitter/resources/image/carousel/study5.jpg" alt="fifth">
				<div class="carousel-caption">
  	  ...
  	  <section class="page col-md-12">
    	   <h2 style="font-weight: bold;">스터디 카테고리</h2>
		      ...
		      <div  class="row" >  
			        ...
			        <img id="life"  class="icon" src="/babySitter/resources/image/lifestyle.png" height="170px" width="170px" align="center" alt="Icon">
			          <h3 >라이프 스타일 </h3> 
			          <p>We offer specialized care forther exotic pets.</p>
			        </section>        
			        
			        <section data-category="2" class="col-md-4">
			        <img id="english"  class="icon" src="/babySitter/resources/image/a.png" height="170px" width="170px" align="middle" alt="Icon">
			          <h3  >영어 </h3>
			          <p>Our therapeutic grooming treatments hhallenging skin conditions.</p>
			        </section>       
			        
			        <section data-category="3" class="col-md-4">
			        <img id="foreign"  class="icon" src="/babySitter/resources/image/foreignL.png" height="170px" width="170px" align="middle" alt="Icon">
			          <h3 >외국어 </h3>
			...
			<br/><br/><br/><br/>   
		      ...
		      <div class="row"> 
			        ...
			        <img id="computer"  class="icon" src="/babySitter/resources/image/computer.png" height="170px" width="170px" align="middle" alt="Icon">
			          <h3 >컴퓨터 </h3>
			          <p>Wellness and senior exams, ultrasound, x-ray,  few of our general health services.</p>
			        </section>    
			            
			        <section data-category="5" class="col-md-4">
			        <img id="design"   class="icon" src="/babySitter/resources/image/design.png" height="170px" width="170px" align="middle" alt="Icon">
			          <h3 >디자인 </h3>
			          <p>Let our nutrition experts review your pet's diet and prescribeth.</p>
			        </section>  
			          
			        <section data-category="6" class="col-md-4">
			        <img id="certification"   class="icon" src="/babySitter/resources/image/certification.png" height="170px" width="170px" align="middle" alt="Icon">
			          <h3 >국가고시 </h3>
				...
				<br/><br/><br/><br/> 
			      ...
			      <div class="row">        
				        <section  data-category="7" class="col-md-4">
					      <img id="job"  class="icon" src="/babySitter/resources/image/job.png" height="170px" width="170px" align="middle" alt="Icon">
				          <h3>취업 </h3>
				          <p>We offer the latest advances in safe and effective </p>
				        </section>        
				        
				        <section data-category="8" class="col-md-4">
					      <img  id="music"   class="icon" src="/babySitter/resources/image/music.png" height="170px" width="170px" align="middle" alt="Icon">
				          <h3>음악공연 </h3>
				          <p>Our veterinarians are experienced in modern vaccination .</p>
				        </section>        
				        
				        <section data-category="9" class="col-md-4">
					      <img id="sports"    class="icon" src="/babySitter/resources/image/sports.png" height="170px" width="170px" align="middle" alt="Icon">
				          <h3>스포츠 </h3>
    	...
    	<section id="staff" class="page col-sm-12">
	      ...
	      <div class="row" align="center">
	        ...
	        <section class="col-sm-4">
	        	 <img class="img-circle" src="/babySitter/resources/image/teacher1.jpg"  height="170px" width="170px" align="middle" alt="Icon">
	     	     <br/> <br/>
	        	 <h3>김 이지</h3>
	          	 <br/><br/>
	        ...
	        <section class="col-sm-4">
	         	<img class="img-circle" src="/babySitter/resources/image/teacher2.jpeg"  height="170px" width="170px" align="middle" alt="Icon">
	          	<br/> <br/>
	          	<h3>유 조이 </h3>
	          	<br/><br/>
	        ...
	        <section class="col-sm-4" >
	        	 <img class="img-circle" src="/babySitter/resources/image/teacher3.jpg"  height="170px" width="170px" align="middle" alt="Icon">
	          	 <br/> <br/>
	         	 <h3>임 해피</h3>
	          	 <br/><br/>
...
<!--BLOCKQUOTE SECTION START  -->
  <div class="row">
      <section id="testimonials" class="page col-sm-12">
        <h2 style="font-weight: bold">스터디 멤버 후기 </h2>
        <br/><br/><br/>
...
/* 로그인 실패 때, 로그인 실패 메시지를 전달해 주는 제이쿼리, 아작스   */
	...
	$(function() {
		$('#btnLogin').on('click', function(event){
			$( '#loginResult' ).text('');
			$.ajax({
				url:"/babySitter/account/login.action",
				type:"POST",
				data:$( '#frmLogin' ).serialize(),
				
				success: function(data,status,xhr){
					if(data=="success"){
						location.href="/babySitter/home.action";
					}else if(data=="fail"){
		...
		$('#btnRegister').on('click', function(event){
			location.href='/babySitter/mother/term.action';
			})

		$('#studyCategory section[data-category]').on('mouseover', function(event){
			$(this).css('border',' #a3a3c2 solid 2px')
		})
		...
		$('#studyCategory section[data-category]').on('click', function(event){	
			location.href='/babySitter/board/list2.action?bigCategory='+$(this).attr('data-category');
		})
...
<!-- 모달에서 페이스북, 카카오톡 로그인   -->	
<form id="frmLogin" action="/babySitter/account/login.action" method="post">
<!-- -----------------------------------Modal----------------------------------- -->
	<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	 	 <div class="modal-dialog">    
	    	  <div class="modal-content">
			      ...
			      <p><!-- 여기는 내용이 들어 가는 곳 --><input class="form-control"  name="motherId" type="text" style="width:350px; height:60px"  placeholder="아이디"> </p>
