<%@page import="com.nhserver.model.dto.BoardComment"%>
<%@page import="com.nhserver.model.dto.Member"%>
<%@page import="com.nhserver.model.dto.Board"%>
...
<head>
	...
	<meta charset="utf-8" />
	<title>글쓰기</title>
	<link rel="Stylesheet" href="/nhserver/resources/styles/default.css" />
	<link rel="Stylesheet" href="/nhserver/resources/styles/input2.css" />
	...
	<div id="pageContainer">
		...
		<div id="inputcontent">
		    <div id="inputmain">
		        ...
		        <% } %>
		        	<a href='replyform.action?boardno=<%= board.getBoardNo() %>&pageno=<%= request.getAttribute("pageno") %>'>댓글쓰기</a>&nbsp;&nbsp;
		...
		<% for (BoardComment bcomment : board.getComments()) { %>
        	<tr>
        		...
        		<div id='commentview<%= bcomment.getCommentNo() %>'>
                    ...
                    <br /><br />
                    <span>
                        <%= bcomment.getContent().replace(" ", "&nbsp;").replace("\r\n", "<br />") %>
                    </span>
                    <br /><br />
                    <%
                    String display = "";
