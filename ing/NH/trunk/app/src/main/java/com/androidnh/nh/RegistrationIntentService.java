...
//                    public void run() {
//                        try {
//                            URL url = new URL("http://192.168.13.27:8088/android-gcm-web/register-id-token.action?client-id-token=" + token2);
...
//                try { thread.join(); } catch (Exception ex) {}
        ...
        registrationComplete.putExtra("server-registration", sb.toString());
